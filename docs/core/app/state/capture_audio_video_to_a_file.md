...
[Cinematics](../../cinematic/cinematics.md)
...
[http://www.aurellem.com/releases/jmeCapture-latest.zip](http://www.aurellem.com/releases/jmeCapture-latest.zip)

[http://www.aurellem.com/releases/jmeCapture-latest.tar.bz2](http://www.aurellem.com/releases/jmeCapture-latest.tar.bz2)

Download the archive in your preferred format, extract,
add the jars to your project, and you are ready to go.

The javadoc is here:
[http://www.aurellem.com/jmeCapture/docs/](http://www.aurellem.com/jmeCapture/docs/)
...
with them.)  Thanks to
[Werner Randelshofer](http://www.randelshofer.ch/blog/2008/08/writing-avi-videos-in-pure-java/)
...
[http://www.xuggle.com/](http://www.xuggle.com/) to learn how to do this.
...
[http://aurellem.org/cortex/html/capture-video.html](http://aurellem.org/cortex/html/capture-video.html)

All source code can be found here:

[http://hg.bortreb.com/audio-send](http://hg.bortreb.com/audio-send)

[http://hg.bortreb.com/jmeCapture](http://hg.bortreb.com/jmeCapture)

More information on the modifications to OpenAL to support multiple
listeners can be found here.

[http://aurellem.org/audio-send/html/ear.html](http://aurellem.org/audio-send/html/ear.html)
