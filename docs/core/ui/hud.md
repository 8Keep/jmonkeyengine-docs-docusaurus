...
![grapplinghook.jpg](http://www.jmonkeyengine.com/wp-content/uploads/2010/10/grapplinghook.jpg)
...
The recommended approach to create HUDs is using [Nifty GUI](../gui/nifty_gui.md).

1. Lay out the &lt;abbr title="Graphical User Interface"&gt;GUI&lt;/abbr&gt; in one or several Nifty XML or Java files.
1. Write the controller classes in Java.
1. Load the XML file with the controller object in your game's simpleInit() method.
...
For HUDs, you basically follow the same instructions as for creating a normal [Nifty GUI](../gui/nifty_gui.md), you just don't pause the game while the HUD is up.

## See also

- [Fonts](../../sdk/plugin/fonts.md)
