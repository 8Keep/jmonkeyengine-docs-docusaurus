...
It is possible to generate an identical J3M file using Java code, by using the classes in the com.jme3.material package. Specifics of the [Material API](https://javadoc.jmonkeyengine.org/com/jme3/material/Material.html) will not be provided in this document. The J3M file above is represented by this Java code:
