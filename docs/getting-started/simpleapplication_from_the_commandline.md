...
Although we recommend the jMonkeyEngine [SDK](../sdk/sdk.md) for developing JME3 games, you can use any IDE (integrated development environment) such as [NetBeans](setting_up_netbeans_and_jme3.md) or [Eclipse](setting_up_jme3_in_eclipse.md), and even work freely from the command-line. Here is a generic IDE-independent "`getting started`" tutorial.
...
You can build JME3 from the sources. (Recommended for JME3 developers.) This example expects [Git](https://help.github.com/articles/set-up-git/) to be installed on your system.
...
:::tip
What is an [RSA key](https://help.github.com/articles/adding-a-new-ssh-key-to-your-github-account/)?
:::
...
To use the engine in a game project, you can use [BootMonkey](https://hub.jmonkeyengine.org/t/bootmonkey-bootstrap-your-jme-project/37141) or clone a template project from GitHub.
...
To install the development version of jme3, download the latest  [stable release](https://github.com/jMonkeyEngine/jmonkeyengine/releases), unzip the folder into a directory named `jme3`. The filenames here are just an example, but they will always be something like `jME3.x-stable`.
...
For [multi-media files, models, and other assets](../tutorials/concepts/multi-media_asset_pipeline.md), we recommend creating the following project structure:
...
This directory structure will allow [SimpleApplication](../core/app/simpleapplication.md)'s default AssetManager to load media files from your `assets` directory, like in this example:
...
Now follow the [tutorials](../tutorials/beginner/beginner.md) and write your first jMonkeyEngine game.
