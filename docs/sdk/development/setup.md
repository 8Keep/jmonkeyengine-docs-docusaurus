...
- Write your plugin (e.g. [create a new editor](../development.md) or [wrap a jar library](extension_library.md))
...
- Commit *only the module project* to trunk:
  ...
  - Enter your googlecode username and commit password (different than login pass, you can find your password [here](https://code.google.com/hosting/settings)!) and press "`Next`"
