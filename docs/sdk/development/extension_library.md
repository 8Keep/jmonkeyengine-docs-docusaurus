...
Make sure you have your SDK set up for plugin development [as described here](setup.md).
...
After you are done, you can [contribute the plugin in the jMonkeyEngine SDK contribution update center](setup.md#jmonkeyengine-sdk-contributions-update-center).
