...
Here is an article on tri-planar mapping: [https://developer.nvidia.com/gpugems/GPUGems3/gpugems3_ch01.html](https://developer.nvidia.com/gpugems/GPUGems3/gpugems3_ch01.html)
...
- You must first use the asset manager to load the scene, see the [hello asset tutorial](../tutorials/beginner/hello_asset.md).
- The terrain (as you can see on the left in the editor) is a sub-node of the scene, so you have to write code to investigate the child nodes of the scene until you find the node that is the terrain, see [this tutorial for scene graph concepts](../tutorials/concepts/the_scene_graph.md).
