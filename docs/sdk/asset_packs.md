...
1. Open it in the SceneComposer by right-clicking it and selecting "`Edit`" in SceneComposer
1. Select the root node of the scene (or another node you want to add the model to)
1. Right-click a model in the AssetBrowser and select "`Add`" to SceneComposer
...
1. Choose "`AssetPack Project`"
1. Fill in the project info and press "`finish`"
...
1. Select "`Add Asset`"..
1. Specify the info about your asset and press Next
1. Press the "`add`" files button and select all files belonging to your asset
1. Select the "`main`" checkbox for the main model file if your asset is a model file
1. Change the asset paths and types if needed and press "`finish`"
...
1. Wavefront .obj
1. jMonkeyEngine3 .j3o
1. Blender .blend (unpack textures)
...
1. Check the description etc. settings, and press "`Next`".
1. Select the checkbox for online and/or local publishing and press "`finish`".
