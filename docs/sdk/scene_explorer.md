...
1. Edit the node in the Properties window (Open via Window→Properties if not open)
1. You can rename a Spatial by right clicking it or by slowly double-clicking the node
...
1. You can move single object within the SceneExplorer tree by dragging&dropping them
