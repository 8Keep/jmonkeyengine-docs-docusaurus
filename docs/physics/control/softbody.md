...
:::warning
Writing in progress, checkout the forum for additional infos [http://hub.jmonkeyengine.org/t/bullet-softbody-in-jme3-1/33110](http://hub.jmonkeyengine.org/t/bullet-softbody-in-jme3-1/33110)
:::
...
[https://en.wikipedia.org/wiki/Soft_body_dynamics](https://en.wikipedia.org/wiki/Soft_body_dynamics)
...
1. checkout the project from [GitHub](https://github.com/Dokthar/jmonkeyengine/tree/bullet_SoftBody).
1. go into the file gradle.properties and set the line : buildNativeProject = true .
1. run the command : ./gradlew build
1. then build the sdk : ant -f ./sdk/ build-zip (or build the sdk installer)
1. create a new project and make sure you use the following libraries : jme3-bullet-native and jme3-bullet (instead of jme3-jBullet)
...
More information on creating [custom meshes](../../core/scene/custom_meshes.md).
