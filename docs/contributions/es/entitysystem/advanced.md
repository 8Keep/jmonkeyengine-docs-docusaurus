...
If you are new to this subject please read the [Entity System Introduction](introduction.md) first.
...
For example [AppStates](../../../core/app/state/application_states.md) can deal with different components and can easily be added to the Application.
