...
Again, the same three options for constructor are available as show in the [Quick Start Guide](quickstart.md).
...
1. Write your code for the event handlers you wish to use
1. Change the Button to a ButtonAdapter
1. Remove all unused event handler methods
