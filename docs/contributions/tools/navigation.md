...
This article describes JME's mercator projection tool. If you don't know what this means, we suggest you begin by reading [The American Practical Navigator](http://en.wikisource.org/wiki/The_American_Practical_Navigator) or browsing Wikipedia. If you do know what a Mercator projection is, then our "`Introduction`" to Marine Navigation might serve to refresh your mind.

[Wikipedia](http://en.wikipedia.org/wiki/Latitude) is a source for formulas shown here. Read it. Absorb it.
