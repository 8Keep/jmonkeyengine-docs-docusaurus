...
1) In order to enable collision physics _at all_, you first need to set up a physics space. There's a great tutorial available in the tutorials section of the jME wiki: [jme3:beginner:hello_physics](../../../tutorials/beginner/hello_physics.md).
