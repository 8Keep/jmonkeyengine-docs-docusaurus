...
There is a tutorial on how to work with alpha textures and transparency here: [jme3:beginner:hello_material](../../../tutorials/beginner/hello_material.md)
...
[http://en.wikipedia.org/wiki/Alpha_to_coverage](http://en.wikipedia.org/wiki/Alpha_to_coverage)
