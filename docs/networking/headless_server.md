...
- Integrate [SpiderMonkey](networking.md), to provide game updates to the server over a network.
...
- Add decent [logging](../tutorials/how-to/java/logging.md) so your server actually makes sense.
