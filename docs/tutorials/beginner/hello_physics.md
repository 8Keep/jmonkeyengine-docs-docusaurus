...
Do you remember the [Hello Collision](hello_collision.md) tutorial where you made the model of a town solid and walked through it in a first-person perspective? Then you may remember that, for the simulation of physical forces, jME3 integrates the [jBullet](http://jbullet.advel.cz/) library.
...
![beginner-physics.png](/wiki-assets/docs/tutorials/assets/images/beginner/beginner-physics.png)
...
1. You attach brick_geo to the rootNode
1. You position brick_geo at `loc`.
1. You create a RigidBodyControl brick_phy for brick_geo.
...
1. You attach ball_geo to the rootNode
1. You position ball_geo at the camera location.
1. You create a RigidBodyControl ball_phy for ball_geo.
...
1. You attach floor_geo to the rootNode
1. You position floor_geo a bit below y=0 (to prevent overlap with other PhysicControl'ed Spatials).
1. You create a RigidBodyControl floor_phy for floor_geo.
