...
![tanlglow2.png](/wiki-assets/docs/tutorials/assets/images/concepts/tanlglow2.png)
...
:::tip
Got no textures? [Download free textures from opengameart.org](http://opengameart.org). Remember to keep the copyright notice together with the textures!
:::

### Texture Mapping

![tank_diffuse.jpg](https://raw.githubusercontent.com/jMonkeyEngine/jmonkeyengine/master/jme3-testdata/src/main/resources/Models/HoverTank/tank_diffuse.jpg)
...
There are two types:
  ...
  - You use Normal Maps to model tiny details such as cracks in walls, rust, skin texture, or a canvas weave ( ([More on BumpMaps](http://en.wikipedia.org/wiki/Bump_mapping)).
  - You use Height Maps to model large terrains with valleys and mountains.
--
![mountains512.png](/wiki-assets/docs/tutorials/assets/images/beginner/mountains512.png)
...
![tank_normals.png](https://raw.githubusercontent.com/jMonkeyEngine/jmonkeyengine/master/jme3-testdata/src/main/resources/Models/HoverTank/tank_normals.png)
...
![tank_specular.jpg](https://raw.githubusercontent.com/jMonkeyEngine/jmonkeyengine/master/jme3-testdata/src/main/resources/Models/HoverTank/tank_specular.jpg)
...
See also this tutorial on [How to make seamless textures in Photoshop](http://www.photoshoptextures.com/texture-tutorials/seamless-textures.htm).
--
...
![glass-teapot1.png](/wiki-assets/docs/tutorials/assets/images/concepts/glass-teapot1.png)
...
See also: [Water](../../core/effect/water.md).
...
A procedural texture is generated from repeating one small image, plus some pseudo-random, gradient variations (called Perlin noise). Procedural textures look more natural than static rectangular textures, and they look less distorted on spheres. On big meshes, their repetitiveness is much less noticeable than with tiled seamless textures. Procedural textures are ideal for irregular large-area textures like grass, soil, rock, rust, and walls. Use the [jMonkeyEngine SDK NeoTexture plugin](../../sdk/neotexture.md) to create them.

![neotexture-2.jpg](/wiki-assets/docs/tutorials/assets/images/concepts/neotexture-2.jpg)

See also: [Blender: Every Material Known to Man](http://en.wikibooks.org/wiki/Blender_3D:_Noob_to_Pro/Every_Material_Known_to_Man)
...
See also: [Understanding Metalness](https://www.chaosgroup.com/blog/understanding-metalness).
...
![blenderswordsman.png](/wiki-assets/docs/tutorials/assets/images/concepts/blenderswordsman.png)
...
1. *Keyframe Animation:* A keyframe is one recorded snapshot of a motion sequence.
...
![300px-surface_normal.png](/wiki-assets/docs/tutorials/assets/images/concepts/300px-surface_normal.png)
...
Slerp is how we pronounce spherical linear interpolation when we are in a hurry. A slerp is an interpolated transformation that is used as a simple "`animation`" in 3D engines. You define a start and end state, and the slerp interpolates a constant-speed transition from one state to the other. You can play the motion, pause it at various percentages (values between 0.0 and 1.0), and play it backwards and forwards. [JavaDoc: slerp()](https://javadoc.jmonkeyengine.org/com/jme3/math/Quaternion.html#slerp-com.jme3.math.Quaternion-com.jme3.math.Quaternion-float-)
...
[Learn more about 3D maths here.](math.md)
...
- [http://en.wikipedia.org/wiki/User:Jreynaga/Books/3D_Graphics_Terms](http://en.wikipedia.org/wiki/User:Jreynaga/Books/3D_Graphics_Terms)
