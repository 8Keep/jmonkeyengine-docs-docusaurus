...
- Using a [Texture Atlas](../../core/jme3tools/optimize/texture_atlas.md) provides limited individual texturing of batched geometries.
...
Generally jME3 is well optimized and optimizes these things correctly. Read [statsview](../../core/app/statsview.md) to learn the details about how to interpret the statistics, how to tell whether your values are off, or whether they point out a problem.
