...
1. Install the MakeHuman application, the Blender application, and the MakeHuman Blender tools.
  - Download the latest stable version of the MakeHuman application from [http://www.makehuman.org/](http://www.makehuman.org/)
  - Download the latest stable MakeHuman Blender tools from [http://www.makehuman.org/](http://www.makehuman.org/)
  - Download the corresponding (not necessarily the latest) version of the Blender application from [http://www.blender.org/](http://www.blender.org/)
  - Install the MakeHuman application as directed by [http://www.makehuman.org/doc/node/install_makehuman.html](http://www.makehuman.org/doc/node/install_makehuman.html)
...
1. Generate an .mhx file containing a human figure.
...
1. Convert the .mhx file to a .blend file:
...
1. Export the file using a [Supported External File Type](../../../../getting-started/features.md#supported-external-file-types):
