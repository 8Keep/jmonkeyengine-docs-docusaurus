...
1. Open the menu `"File &gt; Export &gt; Ogre3D"` to open the exporter dialog.
1. In the `File Path` field: Select a target sub-directory of your `Project Assets/Textures/` directory. E.g. `Project Assets/Textures/ModelName/`. See [Best Practices](../../../concepts/best_practices.md).
1. In the panel at the bottom left of the export window toggle the following export settings:
-  Swap Axis: xz-y
- [*] Separate materials
...
You can now use the [jMonkeyEngine SDK](../../../../sdk/sdk.md) to [load and view models](../../../../sdk/model_loader_and_viewer.md). You can [create scenes](../../../../sdk/scene_composer.md) from them and write code that loads them into your application.
