...
**danielperano:** We have three people on the project.
...
**danielperano:** We’re fully self-funded: no investor or venture-capital backing.
...
**danielperano:** Our first alpha/preview release
will come out around the end of March of this year (2020).

**stephengold:** 
What features will it provide?

**danielperano:** The feature set will depend on what we have time to finish.
...
**danielperano:** Unlike Minecraft, MyWorld is not a game itself ---
...
**danielperano:** Our vision for MyWorld has always been to release it open-source,
...
**danielperano:** While MyWorld needs a virtual currency to effectively operate,
...
**danielperano:** Initially yes, unfortunately.
...
**danielperano:** The client is a typical jME application ---
...
**danielperano:** It uses JavaFX, Lemur, Chipmunk (our in-house scripting language),
...
**danielperano:** Chipmunk was born out of necessity.
...
**danielperano:** I hope so! I’m looking forward to seeing what else it’s used for.

**stephengold:** 
Is there any published documentation for it?
Is it open-source?

**danielperano:** Chipmunk is developed separately from MyWorld and will be released
...
**danielperano:** MyWorld is built around the assumption that users will create digital content.
...
**danielperano:** The best place to go is our [Discord server](https://discordapp.com/invite/WccnrWg).
...
**danielperano:** Thank you! I enjoyed the interview, and I’m looking forward to seeing how jME continues to grow and improve – there’s a lot of great talent behind this project!
